            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="payments.php"  class=" menu-active"><i class="uil uil-invoice"></i>
                                Driver Payments</a>
                            <!-- <div class="collapsible-body left-sub-menu">
                                <ul>
                        ...
                        <li><a href="vehicle_maintenance.php"><i class="uil uil-paint-tool"></i>
