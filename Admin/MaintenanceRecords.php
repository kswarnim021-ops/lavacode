            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="vehicle_maintenance.php" class=" menu-active"><i class="uil uil-paint-tool"></i>
                        ...
                        <li><a href="odometer_tracker.php"><i
                        ...
                        <li><a href="VehicleExpenses.php"></i>
                                Vehicle Expenses</a>
                            <!-- <div class="collapsible-body left-sub-menu">
                                <ul>
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#">Vehicle Maintenance Records</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
